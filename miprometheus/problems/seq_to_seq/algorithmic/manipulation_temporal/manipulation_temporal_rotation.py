...
class ManipulationTemporalRotation(AlgorithmicSeqToSeqProblem):
    """
    Creates input being a sequence of bit pattern and target being the same sequence "rotated" by num_items to the right \
    (DEFAULT: 0.5, meaning that it will be rotated by half of sequence length).
    ...
    1.  -1 < num_items < 1: relative mode, where num_items represents the % of length of the sequence by which it should be "rotated".

    2. Otherwise: absolute number of items by which the sequence will be "rotated".

    .. figure:: ../img/algorithmic/manipulation_temporal/manipulation_temporal_rotation.png
        :scale: 80 %
        :align: center

        Exemplary sequence generated by the Manipulation Temporal Rotation problem (without additional command lines).
    ...
    def __init__(self, params):
        ...
        params.add_default_params({
            'control_bits': 2,
            'data_bits': 8 })
        super(ManipulationTemporalRotation, self).__init__(params)
        self.name = 'ManipulationTemporalRotation'
        ...
        params.add_default_params({'num_items': 0.5})
...
if __name__ == "__main__":
    ...
    problem = ManipulationTemporalRotation(params)
