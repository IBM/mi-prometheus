...
if __name__ == "__main__":
    ...
    params.add_custom_params({'name': 'serial_recall_original', 'control_bits': 4, 'data_bits': 8, 'batch_size': 1,
              'min_sequence_length': 1, 'max_sequence_length': 10, 'num_subseq_min':1 ,'num_subseq_max': 4})
