...
if __name__ == '__main__':
    ...
    # Fields marked as "Optional" may be commented out.
        ...
        setup(
            ...
            keywords='mi-prometheus machine-learning pytorch model problem grid-worker',  # Optional
...
###################################################################################################################
              ...
              license='Apache 2.0',
              packages=find_packages(exclude=('configs', 'build', 'experiments')),
              package_data={},
              scripts=['workers/trainer,'
                       'workers/episode_trainer',
                       'TO COMPLETE'
                       ],
              ...
              keywords='mi-prometheus machine learning',
              )