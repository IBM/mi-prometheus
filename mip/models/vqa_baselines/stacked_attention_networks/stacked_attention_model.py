...
from mip.models.model import Model
from mip.models.vqa_baselines.stacked_attention_networks.stacked_attention_layer import StackedAttentionLayer
...
class StackedAttentionNetwork(Model):
    ...
    def __init__(self, params, problem_default_values_):
        ...
        if params['use_pretrained_cnn']:
            from mip.models.vqa_baselines import PretrainedImageEncoding
            ...
            from mip.models import ConvInputModel
...
if __name__ == '__main__':
    ...
    from mip.problems.image_text_to_class.sort_of_clevr import SortOfCLEVR
