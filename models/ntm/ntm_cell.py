...
class NTMCell(torch.nn.Module):
    ...
    def init_state(self,  batch_size,  num_memory_addresses):
        ...
        * read_vectors are initialize as 0s.
        ...
        return NTMCellStateTuple(ctrl_init_state, interface_init_state,  init_memory_BxMxS, read_vectors_BxM_H)
    ...
    def forward(self, inputs_BxI,  prev_cell_state):
        ...
        (prev_ctrl_state_tuple, prev_interface_state_tuple,  prev_memory_BxMxS, prev_read_vectors_BxM_H) = prev_cell_state
        ...
        read_vectors_BxM_H,  memory_BxMxS, interface_state_tuple = self.interface(inputs_BxI, prev_memory_BxMxS,  prev_interface_state_tuple)
        ...
        cell_state_tuple = NTMCellStateTuple(ctrl_state_tuple, interface_state_tuple,  memory_BxMxS, read_vectors_BxM_H)
