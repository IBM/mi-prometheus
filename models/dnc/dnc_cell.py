...
class DNCCell(nn.Module):
    def __init__(self, output_size, params):
        ...
        self.control_params = ControlParams(output_size, self.interface.read_size, params)
    ...
    def forward(self, input_BxI, cell_state_prev):
        ...
        # Step 1: controller
        output_from_hidden, ctrl_state_tuple, update_data = self.control_params(input_BxI, ctrl_state_prev_tuple, prev_read_vector_BxM)
