...
class ModelBase(object):
    ...
    def plot_sequence(self, data_tuple, output_seq):
        #This code assumes the model is processing agorithmic data which is not particularly useful
        return True
...
#        input_seq = data_tuple.inputs[0].detach().numpy()
#        target_seq = data_tuple.targets[0].detach().numpy()
#        output_seq = output_seq[0].detach.numpy()
#
...
#        
#
#        #TODO CHANGE THIS SO IT DOESN"T ASSUME TYPE OF DATA OR GET RID OF IT
